...
namespace SOTIS_backend.DataAccess.Migrations
{
    ...
    [Migration("20221217202504_AddKnowledgeState")]
    partial class AddKnowledgeState
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SOTIS_backend.DataAccess.Models.KnowledgeState", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("KnowledgeStates");
                });

            modelBuilder.Entity("SOTIS_backend.DataAccess.Models.KnowledgeStateProblem", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("KnowledgeStateId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("KnowledgeStateProblems");
                });
            ...
            modelBuilder.Entity("SOTIS_backend.DataAccess.Models.KnowledgeStateProblem", b =>
                {
                    b.HasOne("SOTIS_backend.DataAccess.Models.KnowledgeState", "KnowledgeState")
                        .WithMany("KnowledgeStateProblems")
            ...
            modelBuilder.Entity("SOTIS_backend.DataAccess.Models.KnowledgeState", b =>
                {
                    b.Navigation("KnowledgeStateProblems");
                });
